...
typedef struct ass_image {
    ...
    enum { IMAGE_TYPE_CHARACTER, IMAGE_TYPE_OUTLINE, IMAGE_TYPE_SHADOW } type;
} ASS_Image;
...
ASS_Track *ass_read_memory(ASS_Library *library, char *buf, size_t bufsize, const char *codepage);
